  ...
  return (
    <div style={{ background: WHITE, color: DARK, fontFamily: "'Plus Jakarta Sans', sans-serif", overflowX: 'hidden' }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '10 10px', height: 68, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24 }}>
          {/* logo */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 16, fontWeight: 800, color: DARK, letterSpacing: '-0.02em', whiteSpace: 'nowrap' }}>Muhammad Ghulam Ali</span>
          </div>

          {/* desktop nav */}
          <div className="hidden lg:flex" style={{ gap: 4, marginLeft: 32, marginRight: 32 }}>
            {navLabels.map((lbl, i) => (
          ...
          {/* AI Assistant link */}
          <a href="https://endearing-churros-970968.netlify.app/" target="_blank" rel="noopener noreferrer" className="hidden lg:flex" style={{
